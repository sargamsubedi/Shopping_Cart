...
namespace OnlineShopping.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> ProductDashboard(string? title)
        {
            ...
            {
                var searchProducts = await _context.Product.Include(p => p.Category).Where(p => p.Title.Contains(title)).ToListAsync();
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Price,ProductPhoto,Description,CategoryId")] Product product,IFormFile Photo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Price,ProductPhoto,Description,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
